...
import { DataSourceService, QueryBuilderService, GroupService, QueryParams } from "@eda/services/service.index";
...
// SDA CUSTOM: en SinergiaDA los permisos de columna solo se gestionan por grupo,
// no existen permisos por usuario individual.
@Component({
    standalone: true,
